...
variable "outbound_clusters" {
  ...
  type = list(object({
    ...
    mode               = string                 # “SEARCH_ONLY”, “REPLICATION_ONLY”, “SEARCH_AND_REPLICATION”, ‘UNKNOWN_ENUM_VALUE’. Any unrecognized values returned by a service will be mapped to ‘UNKNOWN_ENUM_VALUE’.
...
variable "seed_cluster_id" {
  description = "ID of the existing OpenSearch cluster to use as a seed for cross-cluster search"
  type        = string
  default     = ""
}
variable "outbound_cluster_is_enabled" { default = false }
variable "outbound_cluster_display_name" { default = "" }
variable "outbound_cluster_is_skip_unavailable" { default = false }
variable "outbound_cluster_mode" { default = null }
variable "outbound_cluster_ping_schedule" { default = null }
*/
